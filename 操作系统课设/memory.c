...
void CreateMemory(GtkWidget* notebook)
{
    ...
    gtk_table_attach_defaults(GTK_TABLE(table), MEMO_frame1, 0, 5, 6, 10);
    gtk_table_attach_defaults(GTK_TABLE(table), MEMO_frame3, 5, 10, 6, 10);
    gtk_table_attach_defaults(GTK_TABLE(table), MEMO_frame2, 0, 10, 0, 4);
    gtk_table_attach_defaults(GTK_TABLE(table), MEMO_frame4, 0, 10, 4, 6);
...
void ShowMemoInfo(GtkWidget *vbox)
{
    ...
    GtkWidget *vbox5 = gtk_hbox_new(TRUE, 0);
